...
const cartService = {
    ...
    checkout: async (cartId: string, payload: CheckoutPayload): Promise<CartApiResponse<CheckoutResult>> => {
        const res = await api.post(`/api/v1/carts/${cartId}/checkout`, payload);
        return res.data;
    },
};
